...
import com.kanishque.mocktest.Models.ListQues;
...
public class QuizFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable final ViewGroup container, @Nullable Bundle savedInstanceState) {
       ...
       /* Log.d(TAG, "onCreateView: test_time"+test_time);
        ...
        doinBackground();
        long millisec=  test_time*1000;

        countDownTimer = new CountDownTimer(millisec,1000) {
            @Override
            public void onTick(long l) {
                counter.setText(String.format(Locale.US,"%2d:%2d ",
...
*/
    ...
    private void getScore(){
        ...
        int user_selection = radioGroup.getCheckedRadioButtonId();
